...
describe('MiningSubmitMessage', () => {
    ...
    describe('test message parsing', () => {
        ...
        const MINING_SUBMIT_MESSAGE = ' {"id": 5, "method": "mining.submit", "params": ["tb1qumezefzdeqqwn5zfvgdrhxjzc5ylr39uhuxcz4.bitaxe3", "1", "9902000011223344", "64b1f10f", "2402812d", "00006000"]}'
        ...
        it('should parse message', () => {
            ...
            expect(message.extraNonce2).toEqual('9902000011223344');
